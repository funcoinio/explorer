...
<b>Live Version: [funcoin.io](https://funcoin.io)</b>
...
`git clone https://github.com/funcoinio/funcoin-explorer`
...
```json
{
    ...
    "settings": {
        "symbol": "FUNC",
        "name": "FUNCOIN Network",
        "title": "FUNCOIN Network Block Explorer",
        "author": "Creature101"
    }
}
